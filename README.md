...
Feature / Package | vite-plugin-vuetify | webpack-plugin-vuetify | styles[^1] | resolvers[^2] | presets[^3] | vuetify-nuxt-module[^4] |
----------------|---------------------|------------------------|-----------------------|---------------|-------------|-------------------------
...
[^6]: `webpack-plugin-vuetify` not tested with Nuxt 3 with or without SSR
[^7]: `@unvuetify/unimport-presets` components preset can be used with Nuxt imports
